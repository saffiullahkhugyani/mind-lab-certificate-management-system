...
const DonationReceiptDetail = ({
  ...
  return (
    <>
      ...
      <div className=" mx-auto bg-white border border-[#007847] rounded-lg shadow-lg p-3">
        <div ref={contentRef} className="p-3">
          ...
          <div className="flex justify-between mb-6">
            <div>
              <p>
                <strong>Sponsor Name:</strong> {donationReceipt?.sponsor?.name}
              </p>
              <p>
                <strong>Phone:</strong> {donationReceipt?.sponsor?.phone_number}
              </p>
            </div>
            <div className="text-right">
              <p>
                <strong>Sponsor Id:</strong>{" "}
                {donationReceipt?.sponsor?.sponsor_id}
              </p>
              <p>
            ...
            <tbody>
              ...
              >
                ...
                <td className="py-2 text-right px-2">
                  AED {donationReceipt?.amount!}
                </td>
              </tr>
              {donationReceipt?.charges! > 0 && (
                <tr key={donationReceipt?.charges} className="border-b">
                  <td className="py-2 px-2">{"Charges"}</td>
                  <td className="py-2 px-2"></td>
                  <td className="py-2 text-center">{"1"}</td>
                  <td className="py-2 text-right px-2">
                    AED {donationReceipt?.charges!}
                  </td>
                </tr>
              )}
            </tbody>
