...
import ReceiptDetails from "./donation_receipt_details";
...
const DonationReceipt = ({ donationReceipt }: DonationReceiptProps) => {
  ...
  return (
    <div className="grid grid-cols-4 gap-4 bg-white p-4 rounded-lg shadow-md">
      ...
      <div className="col-span-3">
        {selectedReceipt ? (
          <ReceiptDetails donationReceipt={selectedReceipt} />
        ) : (
